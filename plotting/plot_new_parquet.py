...
kinetic = pd.read_parquet("../outputs/old_script_new_xsuite_kinetic.parquet")
simple = pd.read_parquet("../outputs/old_script_new_xsuite_simple.parquet")
analytical = pd.read_parquet("../outputs/old_script_new_xsuite_analytical.parquet")
